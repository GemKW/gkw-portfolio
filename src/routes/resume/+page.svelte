...
>
  ...
  <section id="education" class="space-y-4">
    ...
    <p class="font-semibold text-slate-600 dark:text-slate-300">
      Bachelor of Engineering Science (Biomedical Engineering field)
    </p>
    ...
    <p class="text-slate-600 dark:text-slate-300">
      Tonsley Campus, South Australia
    </p>
  ...
  <section id="professional-experience" class="space-y-4">
    ...
    <p class="font-semibold text-slate-600 dark:text-slate-300">
      Small Business Owner, The Birds and The Beads shop, ETSY Australia
    </p>
    <p class="text-slate-600 dark:text-slate-300">
      (February 2023 – December 2024)
    </p>
    <ul class="list-disc pl-6 space-y-1 text-slate-600 dark:text-slate-300">
      <li>Designed, produced and marketed handmade beaded jewellery.</li>
      <li>Managed inventory, customer relations, budgeting and pricing strategies.</li>
      <li>Enhanced entrepreneurial, organisational and creative problem-solving abilities.</li>
    </ul>
  ...
  <!-- OTHER EXPERIENCE -->
  <section id="other-experience" class="space-y-4">
    <h2 class="text-2xl font-semibold">Other Experience</h2>

    <p class="font-semibold text-slate-600 dark:text-slate-300">
      Data Analysis &amp; AI, Mediacrest Training College
    </p>
    <p class="text-slate-600 dark:text-slate-300">
      (February – March 2026)
    </p>
    <ul class="list-disc pl-6 space-y-1 text-slate-600 dark:text-slate-300">
      <li>Strong foundation in data analysis: handling structured vs unstructured data, data quality, descriptive statistics and analytical thinking.</li>
      <li>Working knowledge of Python for data manipulation, cleaning, analysis and feature engineering.</li>
      <li>Skilled in data visualisation &amp; analytics to analyse distributions, correlations and trends.</li>
      <li>Gained exposure to AI &amp; ML fundamentals, including supervised vs unsupervised learning, model evaluation metrics and ethical AI principles.</li>
    </ul>

    <p class="font-semibold text-slate-600 dark:text-slate-300">
      Research Intern, Summer Research Award, Flinders University
    </p>
    <p class="text-slate-600 dark:text-slate-300">
      (January – March 2024)
    </p>
    <ul class="list-disc pl-6 space-y-1 text-slate-600 dark:text-slate-300">
      <li>Played a key role in the AI Language and Learning project, led by Richard, which explored ChatGPT’s potential in medical education.</li>
      <li>Conducted experiments assessing the integration of Motivational Interviewing techniques to enhance AI-driven training for healthcare professionals.</li>
    </ul>
